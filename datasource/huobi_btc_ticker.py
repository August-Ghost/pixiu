...
class HuobiBtcTicker(ECDataSource):
    def config(self):
        self.configure = {
            "name": "huobi_btc_ticker",  # Required. Your strategy need this to get data.

            "query_config":{
                "api": HuobiAPI_LTC_BTC().stock(market="CNY").ticker_btc_json,
            },
        }
