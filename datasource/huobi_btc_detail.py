...
class HuobiBtcDetail(ECDataSource):
    def config(self):
        self.configure = {
            "name": "huobi_btc_detail",  # Required. Your strategy need this to get data.

            "query_config":{
                "api": HuobiAPI_LTC_BTC().stock(market="CNY").detail_btc_json,
            },
        }
